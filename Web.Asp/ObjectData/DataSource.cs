namespace Web.Asp.ObjectData
{
    ...
    public static class DataSource
    {
        ...
        private static IEnumerable<ItemIntSimple> GHTKOrderStatus = new List<ItemIntSimple>
        {
            new ItemIntSimple { Id = -1, Name = "Hủy đơn hàng." },
            new ItemIntSimple { Id = 1, Name = "Chưa tiếp nhận." },
            new ItemIntSimple { Id = 2, Name = "Đã tiếp nhận." },
            new ItemIntSimple { Id = 3, Name = "Đã lấy hàng/Đã nhập kho." },
            new ItemIntSimple { Id = 4, Name = "Đã điều phối giao hàng/Đang giao hàng." },
            new ItemIntSimple { Id = 5, Name = "Đã giao hàng/Chưa đối soát." },
            new ItemIntSimple { Id = 6, Name = "Đã đối soát." },
            new ItemIntSimple { Id = 7, Name = "Không lấy được hàng." },
            new ItemIntSimple { Id = 8, Name = "Hoãn lấy hàng." },
            new ItemIntSimple { Id = 9, Name = "Không giao được hàng." },
            new ItemIntSimple { Id = 10, Name = "Delay giao hàng." },
            new ItemIntSimple { Id = 11, Name = "Đã đối soát công nợ trả hàng." },
            new ItemIntSimple { Id = 12, Name = "Đã điều phối lấy hàng/Đang lấy hàng." },
            new ItemIntSimple { Id = 13, Name = "Đơn hàng bồi hoàn." },
            new ItemIntSimple { Id = 20, Name = "Đang trả hàng (COD cầm hàng đi trả)." },
            new ItemIntSimple { Id = 21, Name = "Đã trả hàng (COD đã trả xong hàng)." },
            new ItemIntSimple { Id = 123, Name = "Shipper báo đã lấy hàng." },
            new ItemIntSimple { Id = 127, Name = "Shipper (nhân viên lấy/giao hàng) báo không lấy được hàng." },
            new ItemIntSimple { Id = 128, Name = "Shipper báo delay lấy hàng." },
            new ItemIntSimple { Id = 45, Name = "Shipper báo đã giao hàng." },
            new ItemIntSimple { Id = 49, Name = "Shipper báo không giao được giao hàng." },
            new ItemIntSimple { Id = 410, Name = "Shipper báo delay giao hàng." },
        };
        public static List<ItemIntSimple> GHTKOrderStatusCollection = GHTKOrderStatus.ToList();
    }
