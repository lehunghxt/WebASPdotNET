...
namespace Web.Model
{
    ...
    public partial class WEBCONFIGModel
    {
        ...
        public string OnePayAccessKey { get; set; }
        public string OnePaySecret { get; set; }
        public string AccessTradeSecretKey { get; set; }
        public string AccessTradeAccessKey { get; set; }
        public string AccessTradeSourceId { get; set; }
        public string AccessTradeDeepLink { get; set; }
