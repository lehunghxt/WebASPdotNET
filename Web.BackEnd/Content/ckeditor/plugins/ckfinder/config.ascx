...
<%@ Import Namespace="Web.Asp.Security" %>;
...
<script runat="server">
    public int CompanyId
    {
        get
        {
            var user = this.Page.User as UserPrincipal;
            if (user == null) return 0;
            else return user.CompanyId;
        }
    }
    /**
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = string.Format("{0}://{1}{2}{3}Uploads/C{4}/",
        ...
        BaseDir = AppDomain.CurrentDomain.BaseDirectory.Replace("\\", "/") + "Uploads/C" + CompanyId + "/";
