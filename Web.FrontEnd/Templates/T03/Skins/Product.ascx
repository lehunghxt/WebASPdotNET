                        ...
                        <div class="price uk-flex uk-flex-middle uk-flex-space-between">
                            <%=Convert.ToDecimal(r.Price) > 0
                                    ? Convert.ToDecimal(r.Sale) > 0 ?
                                        "<span class='price'>" + String.Format("{0:0,0}", r.Sale) + "<sup>đ</sup></span><br><del>" + String.Format("{0:0,0}đ", r.Price) + "<sup>đ</sup></del>"
                                        : "<span class='price'>" + String.Format("{0:0,0}", r.Price) + "<sup>đ</sup></span>"
                                    : "Liên hệ"%>
                        </div>
