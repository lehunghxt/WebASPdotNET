...
<div class="row prd-detail">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active" id="product<%=dto.ID %>">
                            <img class="img-responsive" style="width: 100%;" src="<%=dto.PathImage%>" alt="<%=dto.Title%>">
                        </div>
                        <%foreach (var image in this.Images)
                                   {%>
					     <div class="item">
                            <img class="img-responsive" style="width: 100%;" src="<%=image.PathImage%>" alt="<%=dto.Title%>">
                        </div>				
                               <%} %>
                    </div>
    ...
    <%}%>
            <div class="col-md-12 panel-body">
                <div class="prd-infor">
                <div class="content" style='margin:15px 0px'><%=dto.Contents%></div>
                    </div>
            </div>
            <div class="col-md-12">
                Tag: 
