     ...
     <%if (trans != null)
         {
             ...
             if (trans.OrderType == "QT") status = Web.Asp.ObjectData.DataSource.OnePayVisaStatusCollection.Where(e => e.Id == trans.ResponseCode).Select(e => e.Name).FirstOrDefault();
             else if (trans.OrderType == "ND") status = Web.Asp.ObjectData.DataSource.OnePayATMStatusCollection.Where(e => e.Id == trans.ResponseCode).Select(e => e.Name).FirstOrDefault();
             %>
