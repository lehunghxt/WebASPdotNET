...
var sagscroller_constants={
    navpanel: { height: '16px', downarrow: '/templates/T0160/images/down.gif', opacity: 0.6, title: 'Go to Next Content', background: 'black' },
    loadingimg: { src: '/templates/T0160/images/ajaxloading.gif', dimensions: [100, 15] }
}
...
sagscroller.prototype={
	...
	addnavpanel:function(){
		...
		var $navpanel = jQuery('<div class="sliderdesc"><div class="sliderdescbg"></div><div class="sliderdescfg"><div class="sliderdesctext"></div></div></div>')
