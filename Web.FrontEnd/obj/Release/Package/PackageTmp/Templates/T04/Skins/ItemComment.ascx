...
<div class="lib_feedback_form" style="padding:0 16px; width:100%">
    ...
    <div class="main_panel_header"><%=Language["Your idea"] %></div>
    <div class="rows">
        <div class="w3-col m4"><input type="text" id="commentname" name="commentname" class="input" placeholder="<%=Language["Name"] %>"/></div>
        <div class="w3-col m4"><input type="text" id="commentphone" name="commentphone" class="input" placeholder="<%=Language["Phone"] %>"/></div>
        <div class="w3-col m4"><input type="text" id="commentemail" name="commentemail" class="input" placeholder="<%=Language["Email"] %>"/></div>
        <div class="w3-col m12"><textarea id="commentcontent" name="commentcontent" class="contents" placeholder="<%=Language["Contents"] %>"></textarea></div>
    </div>
    <div style="text-align:center">
        ...
        <div class="rows">
    <input type="button" class="form_button" value="<%=Language["Send"] %>" onclick="Comment_post()"/>
            </div>
    </div>
</div>
