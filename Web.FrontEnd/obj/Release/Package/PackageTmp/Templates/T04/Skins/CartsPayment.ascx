...
<div class="row">                    							
    <div class="col-lg-12 col-md-12 col-sm-12">                        	
        ...
        <table class="w3-table w3-striped w3-border w3-bordered w3-hoverable" style="width:100%">                            	
            <tr class="w3-green">
        ...
        <div class="w3-container">
            ...
            <div class="w3-row" style="margin-top:20px">
                ...
                <div class="w3-col m6 l6 s12">
                    ...
                    <asp:TextBox ID="txtHoTen" CssClass="w3-input w3-border w3-round" required="required" runat="server" MaxLength="300" placeholder="Họ tên người nhận"></asp:TextBox>
                    <br /><br />
                </div>
                                    
                <div class="w3-col m6 l6 s12">
                    <label>Số điện thoại người nhận</label>
                    <asp:TextBox ID="txtDienThoai" CssClass="w3-input w3-border w3-round" runat="server" MaxLength="300" required="required" placeholder="Số điện thoại người nhận"></asp:TextBox>
                    <br /><br />
                </div>

                 <div class="w3-col m6 l6 s12">
                     <label>Email người đặt hàng</label>
                    <asp:TextBox ID="txtMail" CssClass="w3-input w3-border w3-round" runat="server" placeholder="Email người đặt hàng"></asp:TextBox>
                     <br /><br />
                </div>

                <div class="w3-col m6 l6 s12">
                    <label>Địa chỉ giao hàng</label>
                    <asp:TextBox ID="txtDiaChi" CssClass="w3-input w3-border w3-round" runat="server" required="required" placeholder="Địa chỉ giao hàng"></asp:TextBox>
                    <br /><br />
                </div>

                <div class="w3-col m12 l12 s12">
                    <label>Ghi chú</label>
                    <asp:TextBox ID="txtNote" CssClass="w3-input w3-border w3-round" runat="server" TextMode="MultiLine" Height="100px" placeholder="Ghi chú"></asp:TextBox>
                    <br />
                </div>
...
<div class="w3-row" style="margin-top:20px">  
            ...
            <h4>Thông tin vận cuyển và thanh toán</h4>
        </div>
                    <div class="w3-container">
...
<div class="w3-row" style="margin:15px; text-align:right">
                    <asp:Button ID="imbHoanTat" runat="server" onclick="imbHoanTat_Click" CssClass="w3-btn w3-ripple w3-orange" Text="Gửi đơn hàng" />
    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data != "") {
                    ...
                    document.getElementById("totalfee").innerHTML = tongtienmoi;
